...
let JWT, USER_TYPE, LONG_LINK, CUSTOM_LINK, URL_ID // APPENDIX ENV DATA
...
if(USER_TYPE === 'admin') {
    if(DB_TYPE === 'mongo') {
        JWT = __ENV.JWT_ADMIN_NOSQL
        URL_ID = __ENV.URL_ID_ADMIN_NOSQL
    }else {
        JWT = __ENV.JWT_ADMIN_SQL
        URL_ID = __ENV.URL_ID_ADMIN_SQL
    }
} else {
    if(DB_TYPE === 'mongo') {
        JWT = __ENV.JWT_USER_NOSQL
        URL_ID = __ENV.URL_ID_USER_NOSQL
    }else {
        JWT = __ENV.JWT_USER_SQL
        URL_ID = __ENV.URL_ID_USER_SQL
    }
}
