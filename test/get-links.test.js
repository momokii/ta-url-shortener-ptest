...
let JWT, PAGE, PER_PAGE // APPENDIX ENV DATA
...
else JWT = __ENV.JWT_ADMIN_SQL // because we need to login as admin
...
export default function () {
    ...
    endpoint = `${endpoint}/links?page=${PAGE}&per_page=${PER_PAGE}` 
